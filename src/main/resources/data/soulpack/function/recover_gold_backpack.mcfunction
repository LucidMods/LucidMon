...
execute unless entity @e[type=minecraft:item,tag=soulpack_recovery_item,limit=1] run tellraw @s {"text":"No loaded dropped Gold Backpack was found in your current dimension.","color":"red"}
